...
type Config struct {
	DesiredServicesFunc func(ctx context.Context, obj interface{}) (*[]apiv1.Service, error)
	// Dependencies.
...
func New(config Config) (*Resource, error) {
	if config.DesiredServicesFunc == nil {
		return nil, microerror.Maskf(invalidConfigError, "config.DesiredServicesFunc must not be empty")
	}
	// Dependencies.
